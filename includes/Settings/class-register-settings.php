...
class Register_Settings {
	...
	public function register_menu() {
		...
		if ( ! isset( $admin_page_hooks['jetixwp'] ) ) {
			add_menu_page(
				_x( 'JetixWP Plugins', 'Page title', 'really-simple-featured-image' ),
				_x( 'JetixWP', 'Menu title', 'really-simple-featured-image' ),
				'manage_options',
				$primary_slug,
				'__return_null',
				$menu_icon,
	...
	public function save_settings() {
		...
		// Check user capability before processing settings.
 ...
 * @return string|array
 */
function rs_featured_image_clean( $var ) {
	if ( is_array( $var ) ) {
		return array_map( __NAMESPACE__ . '\rs_featured_image_clean', $var );
	}
